...
###################
			$TABLE[begin2] =
"
<table border=$TABLES_VARS[border] width=$TABLES_VARS[adm_main2_width] bgcolor=$TABLES_VARS[main2_bgcolor] align=$TABLES_VARS[main2_align] cellspacing=$TABLES_VARS[main2_cellspacing] cellpadding=$TABLES_VARS[main2_cellpadding]>
<tr>
";
###################
        	        $TABLE[left_up_begin]  !=
