...
\t\t<table border=$TABLES_VARS[border] width=100% bgcolor=$TABLES_VARS[header1_bgcolor] align=$TABLES_VARS[header1_align] cellspacing=$TABLES_VARS[header1_cellspacing] cellpadding=$TABLES_VARS[header1_cellpadding]>\t\t<tr><td>
\t\t";
...
\t\t<table border=$TABLES_VARS[border] width=100% bgcolor=$TABLES_VARS[header2_bgcolor] align=$TABLES_VARS[header2_align] cellspacing=$TABLES_VARS[header2_cellspacing] cellpadding=$TABLES_VARS[header2_cellpadding]>
\t\t<tr><td>
\t\t";
